...
import { r as readable, w as writable } from './chunks/index-DNLACmyX.js';
import 'clsx';
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets + '/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n		<link rel="stylesheet" href="' + assets + '/app.css" />\n	</head>\n	<body data-sveltekit-preload-data="hover" class="bg-background text-text font-sans">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n",
